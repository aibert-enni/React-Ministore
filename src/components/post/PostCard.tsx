  ...
  return (
    <Link className="group" to={'/post/' + postCard.id}>
      ...
      <div className="title flex-col mt-4">
        <p className="font-jost text-[#848484]">{postCard.date} - {postCard.categories && postCard.categories.join(' ')}</p>
        <p className="group-hover:text-[#72AEC8] font-jost text-xl mt-1">
          {postCard.title}
        </p>
      </div>
    </Link>
