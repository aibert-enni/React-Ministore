...
const NavItems = () => {
    ...
    return (
        <div className='flex gap-10 mr-28'>
            <Link className='uppercase font-medium hover:underline underline-offset-2' to={ROUTES_PATHS.HOME}>home</Link>
            <Link className='uppercase font-medium hover:underline underline-offset-2' to={ROUTES_PATHS.ABOUT}>about</Link>
            <div className="group">
                <div className="flex items-end">
                    <p onClick={() => setIsClicked(!isClicked)} className="cursor-pointer uppercase font-medium">pages</p>
                ...
                <div className='group-hover:flex absolute hover:flex flex-col bg-white px-2 py-2 gap-2 rounded-md shadow hidden'>
                    <Link className='uppercase font-medium hover:underline underline-offset-2' to={ROUTES_PATHS.SHOP}>shop</Link>
